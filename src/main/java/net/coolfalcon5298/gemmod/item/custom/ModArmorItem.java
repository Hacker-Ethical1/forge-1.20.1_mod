...
import net.coolfalcon5298.gemmod.item.ModArmorMaterials;
    ...
    public void onArmorTick(ItemStack stack, Level world, Player player) {
        if (!world.isClientSide()) {
            if (hasFullSuitOfArmorOn(player) && hasCorrectArmorOn(ModArmorMaterials.SAPPHIRE, player)) {
                // Only add the effect if it's not already active
                ...
                // Remove Night Vision if they no longer have the full armor
